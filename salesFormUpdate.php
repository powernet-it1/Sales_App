                            ...
                            <div class="row">
                                <div class="col-12 mb-4">
                                    <select class="form-select form-control-lg" name="sts" required>
                                        ...
                                        <option value="Option 2" <?php if($row['sts'] == 'Option 2') echo 'selected'; ?>>Option 2</option>
                                        <option value="Subject 3" <?php if($row['sts'] == 'Subject 3') echo 'selected'; ?>>Subject 3</option>
                                    </select>
